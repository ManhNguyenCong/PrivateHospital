...
class DetailServiceFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.btnAppointment.setOnClickListener {
            val action = DetailServiceFragmentDirections.actionDetailServiceFragmentToAppointmentFragment()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.getServiceById(args.id).observe(this.viewLifecycleOwner) { service ->
            ...
            // Set date-time
            binding.tvDateTime.text = String.format("%02d:00-%02d:00; %s", service.timeStart, service.timeEnd, service.weekDays)
            // Set describe
